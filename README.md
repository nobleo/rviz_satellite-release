...
The packages in the `rviz_satellite` repository were released into the `rolling` distro by running `/usr/bin/bloom-release rviz_satellite -y -r rolling` on `Thu, 18 Dec 2025 12:49:43 -0000`
...
## rviz_satellite (rolling) - 4.3.0-1

The packages in the `rviz_satellite` repository were released into the `rolling` distro by running `/usr/bin/bloom-release rviz_satellite -y --rosdistro rolling` on `Wed, 05 Nov 2025 15:51:14 -0000`
...
## rviz_satellite (kilted) - 4.3.0-1

The packages in the `rviz_satellite` repository were released into the `kilted` distro by running `/usr/bin/bloom-release rviz_satellite -y --rosdistro kilted` on `Wed, 05 Nov 2025 15:49:34 -0000`
...
## rviz_satellite (jazzy) - 4.3.0-1

The packages in the `rviz_satellite` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release rviz_satellite -y --rosdistro jazzy` on `Wed, 05 Nov 2025 15:47:57 -0000`
...
## rviz_satellite (kilted) - 4.2.1-1

The packages in the `rviz_satellite` repository were released into the `kilted` distro by running `/usr/bin/bloom-release rviz_satellite --rosdistro kilted -y` on `Thu, 07 Aug 2025 07:16:12 -0000`
...
## rviz_satellite (jazzy) - 4.2.0-1

The packages in the `rviz_satellite` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release rviz_satellite --rosdistro jazzy -y` on `Tue, 20 May 2025 12:38:53 -0000`
